...
include "koneksi.php";
    ...
    $sqlmenu = mysqli_query($conn,"SELECT * FROM tbl_menu WHERE id_menu = '$idmenu'");
    $menu =mysqli_fetch_array($sqlmenu);
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="panel panel-default" style="width: 75%; margin:auto; margin-top:30px; margin-bottom:30px;">
                       ...
                       <form action="action.php?aksi=editmenu&amp;id=<?= $idmenu ?>" method="post" enctype="multipart/form-data" autocomplete="off" style="width:75%; margin:auto;">
                            <div class="form-group">
                                <label for="id">Id</label>
                                <input type="text" class="form-control" name="id" required value="<?=$menu['id_menu']?>"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="stok" required value="<?=$menu['stok']?>"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                            <label>Jenis</label>
                                            <select class="form-control" name="jenis" required value="<?=$menu['jenis']?>">
