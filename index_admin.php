	...
	<div class="section" style=" margin:0 auto; position: absolute; left:50%; top:50%; transform:translate(-50%, -50%); width: 600px;">
        <div class="bg p-4 mb-5 mt-5 text text-center text-black" style="width:75%; margin: auto;">
            <div class="container">
                ...
                <h5 class="headerp text-dark">Selamat datang di Aplikasi My Coffe!!</h5>
				<p class="headerp text-dark">Silakan login terlebih dahulu</p>
                    <div class="datainput">
                        <form action="ceklogin_adm102021.php" method="post" autocomplete="off" class="m-3">
